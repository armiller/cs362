...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card ) 
    {
        ...
        case baron:
            ...
            cardBaron(choice1, choice2, choice3, state, handPos, bonus);
            return 0;
        ...
        case minion:
            ...
            cardMinion(choice1, choice2, choice3, state, handPos, bonus);
            return 0;

        case steward:

            cardSteward(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
            return 0;

        case tribute:
            
            cardTribute(choice1, choice2, choice3, state, handPos, bonus);
            return 0;

        case ambassador:
   	
            cardAmbassador(choice1, choice2, choice3, state, handPos, bonus);
            return 0;
...
void cardSteward(int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int currentPlayer) {
...
void cardTribute(int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
...
void cardBaron(int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
...
void cardAmbassador(int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
...
void cardMinion(int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
    //+1 action
    state->numActions++;
